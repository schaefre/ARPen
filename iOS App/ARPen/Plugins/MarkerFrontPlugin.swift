...
class MarkerFrontPlugin: Plugin, UserStudyRecordPluginProtocol {
    ...
    override init() {
        ...
        self.pluginImage = UIImage.init(named: "MarkerFrontPlugin")
        self.pluginInstructionsImage = UIImage.init(named: "MarkerFrontPluginInstructions")
        self.pluginIdentifier = "Front"
        self.needsBluetoothARPen = false
        self.pluginDisabledImage = UIImage.init(named: "MarkerFrontPluginDisabled")
    }
    ...
    override func activatePlugin(withScene scene: PenScene, andView view: ARSCNView){
        ...
        scene.markerBox.setModel(newmodel: Model.front)
