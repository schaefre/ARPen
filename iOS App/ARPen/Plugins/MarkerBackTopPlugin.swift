...
class MarkerBackTopPlugin: Plugin, UserStudyRecordPluginProtocol {
    ...
    override init() {
        ...
        self.pluginImage = UIImage.init(named: "MarkerBackTopPlugin")
        self.pluginInstructionsImage = UIImage.init(named: "MarkerBackTopPluginInstructions")
        self.pluginIdentifier = "BackTop"
        self.needsBluetoothARPen = false
        self.pluginDisabledImage = UIImage.init(named: "MarkerBackTopPluginDisabled")
    }
    ...
    override func activatePlugin(withScene scene: PenScene, andView view: ARSCNView){
        ...
        scene.markerBox.setModel(newmodel: Model.backtop)
