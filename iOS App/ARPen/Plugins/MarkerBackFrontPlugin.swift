...
class MarkerBackFrontPlugin: Plugin, UserStudyRecordPluginProtocol {
    ...
    override init() {
        ...
        self.pluginImage = UIImage.init(named: "MarkerBackFrontPlugin")
        self.pluginInstructionsImage = UIImage.init(named: "MarkerBackFrontPluginInstructions")
        self.pluginIdentifier = "BackFront"
        self.needsBluetoothARPen = false
        self.pluginDisabledImage = UIImage.init(named: "MarkerBackFrontPluginDisabled")
    }
    ...
    override func activatePlugin(withScene scene: PenScene, andView view: ARSCNView){
        ...
        scene.markerBox.setModel(newmodel: Model.backfront)
