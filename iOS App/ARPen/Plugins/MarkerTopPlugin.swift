...
class MarkerTopPlugin: Plugin, UserStudyRecordPluginProtocol {
    ...
    override init() {
        ...
        self.pluginImage = UIImage.init(named: "MarkerTopPlugin")
        self.pluginInstructionsImage = UIImage.init(named: "MarkerTopPluginInstructions")
        self.pluginIdentifier = "Top"
        self.needsBluetoothARPen = false
        self.pluginDisabledImage = UIImage.init(named: "MarkerTopPluginDisabled")
    }
